...
export default function SidebarToggle({ className }: SidebarToggleProps) {
    ...
    return (
        <button
            ...
            className={`inline-flex items-center justify-center p-2 rounded-md text-white bg-slate-800 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary shadow-lg ${className}`}
